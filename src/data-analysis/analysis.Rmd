...
|---------------|:-------------:|
| neighborhood      | The respective neighborhood in Amsterdam to which the data pertains to. |
...
| crime_type_category | The type of crime to which the data pertains to. |
