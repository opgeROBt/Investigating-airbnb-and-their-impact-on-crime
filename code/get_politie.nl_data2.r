...
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.1.1", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.1.2", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.2.1", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.2.2", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.2.3", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.2.4", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.2.5", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.6", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.7", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.5.2", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.6.2", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.5.1", "Robbery/Theft")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.5.2", "Robbery/Theft")

# Red = Violence
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.3.1", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.1", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.2", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.3", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.4", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.4.5", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.6.1", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.2.1", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.4.1", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.4.2", "Violence")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.6.4", "Violence")

# Purple = Smuggling
all_data$CrimeType <- str_replace(all_data$CrimeType, "1.6.3", "Smuggling")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.1.1", "Smuggling")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.1.2", "Smuggling")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.1.3", "Smuggling")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.2.1", "Smuggling")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.2.2", "Smuggling")

# Blue = Inappropriateness
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.1.1", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.3.2", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.3.5", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.4.2", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.5.2", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.5.5", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.7.1", "Inappropriateness")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.7.2", "Inappropriateness")

# Green = Environment
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.1", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.2", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.3", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.4", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.5", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.7", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.8", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.9", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.10", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.11", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.12", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.13", "Environmental")
all_data$CrimeType <- str_replace_all(all_data$CrimeType, "2.6.14", "Environmental")

#all_data$CrimeType <- str_replace(all_data$CrimeType, "Environmental0", "Environmental")
#all_data$CrimeType <- str_replace(all_data$CrimeType, "Environmental1", "Environmental")
#all_data$CrimeType <- str_replace(all_data$CrimeType, "Environmental2", "Environmental")
#all_data$CrimeType <- str_replace(all_data$CrimeType, "Environmental3", "Environmental")
#all_data$CrimeType <- str_replace(all_data$CrimeType, "Environmental4", "Environmental")

# Gray = Other
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.7.2", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "2.7.3", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.7.3", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.7.4", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.9.1", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.9.2", "Other")
all_data$CrimeType <- str_replace(all_data$CrimeType, "3.9.3", "Other")


all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639200","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639201","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639203","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639204","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639205","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639202","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639206","Bijlmer-Centrum")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633601","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633600","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633700","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633702","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633703","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633704","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633706","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633705","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633802","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633803","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633900","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633901","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633902","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03633903","Bos en Lommer")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03632300","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03632301","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03632302","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03632303","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03632304","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03635900","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03635901","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639004","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639000","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639002","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639003","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639008","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639009","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639103","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639100","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639101","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03639102","Buitenveldert - Zuidas")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630300","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630301","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630302","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630303","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630304","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630305","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630306","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630400","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630401","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630402","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630403","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630404","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630405","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630406","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630407","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630408","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630700","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630701","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630702","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630703","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630704","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630705","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630706","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630707","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630800","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630801","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630804","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630803","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630901","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630902","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630903","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630905","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630907","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630908","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630900","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630904","Centrum-Oost")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630001","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630003","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630004","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630000","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630002","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630100","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630101","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630102","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630103","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630104","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630105","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630106","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630107","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630200","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630202","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630203","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630201","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630501","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630502","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630503","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630505","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630506","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630500","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630600","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630602","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630603","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630604","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630605","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630606","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630607","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630610","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630611","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630608","Centrum-West")							
all_data$Neighborhoods <- str_replace(all_data$Neighborhoods, "BU03630609","Centrum-West")							
