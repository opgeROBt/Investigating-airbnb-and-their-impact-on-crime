...
# map values to the crimetype codees
politie_data.datatable <- politie_data.datatable %>% 
  mutate(crimetype_name = case_when(
...
for (item in bijlmer_centrum) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Bijlmer-Centrum")
...
for (item in bos_en_lommer) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Bos en Lommer")
...
for (item in buitenveldert_zuidas) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Buitenveldert - Zuidas")
...
for (item in centrum_oost) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Centrum-Oost")
...
for (item in centrum_west) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Centrum-West")
...
for (item in de_akker_nieuw_sloten) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "De Akker - Nieuw Sloten")
...
for (item in de_pijp_rivierenbuurt) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "De Pijp - Rivierenbuurt")
...
for (item in gaasperdam_driemond) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Gaasperdam - Driemond")
...
for (item in geuzenveld_slotermeer) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Geuzenveld - Slotermeer")
...
for (item in ijburg_zeeburgereiland) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "IJburg - Zeeburgereiland")
...
for (item in noord_oost) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Noord-Oost")
...
for (item in noord_west) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Noord-West")
...
for (item in oostelijk_havengebied_indische_buurt) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Oostelijk Havengebied - Indische Buurt")
...
for (item in osdorp) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Osdorp")
...
for (item in de_baarsjes_oud_west) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "De Baarsjes - Oud-West")
...
for (item in oud_noord) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Oud-Noord")
...
for (item in oud_oost) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Oud-Oost")
...
for (item in zuid) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Zuid")
...
for (item in slotervaart) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Slotervaart")
...
for (item in watergraafsmeer) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Watergraafsmeer")
...
for (item in westerpark) politie_data.datatable$Neighborhood_names <- str_replace(politie_data.datatable$Neighborhoods, item, "Westerpark")
...
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM01", "Jan2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM02", "Feb2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM03", "Mrt2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM04", "Apr2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM05", "May2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM06", "June2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM07", "July2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM08", "Aug2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM09", "Sept2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM10", "Oct2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM11", "Nov2021")
politie_data.datatable$Periods <- str_replace(politie_data.datatable$Periods, "2021MM12", "Dec2021")
