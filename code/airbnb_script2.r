...
for (.v in WijkEnBuurten_combined) WijkEnBuurten_combined <- cbs_get_data("47022NED", 
                                                            catalog = "politie",
                                                            Perioden = perioden_police_ams,
                                                            WijkenEnBuurten = .v,
                                                            select = c("WijkenEnBuurten","Perioden","SoortMisdrijf","GeregistreerdeMisdrijven_1"))

names(WijkEnBuurten_combined)[names(WijkEnBuurten_combined) == "WijkenEnBuurten"] <- "Neighborhoods"
names(WijkEnBuurten_combined)[names(WijkEnBuurten_combined) == "Perioden"] <- "Periods"
names(WijkEnBuurten_combined)[names(WijkEnBuurten_combined) == "SoortMisdrijf"] <- "CrimeType"
names(WijkEnBuurten_combined)[names(WijkEnBuurten_combined) == "GeregistreerdeMisdrijven_1"] <- "RegisteredCrimes"

View(WijkEnBuurten_combined)

WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, "0.0.0", "Total")

# Yellow = Robbery/Theft
rob <- c("1.1.1", "1.1.2", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.4.6", "1.4.7", "1.5.2", "1.6.2", "2.5.1", "2.5.2")
for (.v in rob)  WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Robbery/Theft")

# Red = Violence
vio <- c("1.3.1", "1.4.1", "1.4.2", "1.4.3", "1.4.4", "1.4.5", "1.6.1", "2.2.1", "2.4.1", "2.4.2", "3.6.4")
for (.v in vio) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Violence")

# Purple = Smuggling
smu <- c("1.6.3", "3.1.1", "3.1.2", "3.1.3", "3.2.1", "3.2.2")
for (.v in smu) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Smuggling")

# Blue = Inappropriateness
ina <- c("2.1.1","3.3.2","3.3.5","3.4.2","3.5.2","3.5.5","3.7.1","3.7.2")
for (.v in ina) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Inappropriateness")

# Green = Environment
env <- c("2.6.1","2.6.2","2.6.3","2.6.4","2.6.5","2.6.7","2.6.8","2.6.9","2.6.10","2.6.11","2.6.12","2.6.13","2.6.14")
for (.v in env) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Environment")

# Gray = Other
gra <- c("2.7.2","2.7.3","3.7.3","3.7.4","3.9.1","3.9.2","3.9.3")
for (.v in gra) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Other")

# City Areas:
bijlmer_centrum <- c("BU03639200","BU03639201","BU03639203","BU03639204","BU03639205","BU03639202","BU03639206")
for (.v in bijlmer_centrum) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Bijlmer-Centrum")
...
for (.v in bos_en_lommer) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Bos en Lommer")
...
for (.v in buitenveldert_zuidas) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Buitenveldert - Zuidas")
...
for (.v in centrum_oost) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Centrum-Oost")
...
for (.v in centrum_west) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Centrum-West")
...
for (.v in de_akker_nieuw_sloten) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "De Akker - Nieuw Sloten")
...
for (.v in de_pijp_rivierenbuurt) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "De Pijp - Rivierenbuurt")
...
for (.v in gaasperdam_driemond) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Gaasperdam - Driemond")
...
for (.v in geuzenveld_slotermeer) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Geuzenveld - Slotermeer")
...
for (.v in ijburg_zeeburgereiland) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "IJburg - Zeeburgereiland")
...
for (.v in noord_oost) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Noord-Oost")
...
for (.v in noord_west) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Noord-West")
...
for (.v in oostelijk_havengebied_indische_buurt) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Oostelijk Havengebied - Indische Buurt")
...
for (.v in osdorp) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Osdorp")
...
for (.v in de_baarsjes_oud_west) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "De Baarsjes - Oud-West")
...
for (.v in oud_noord) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Oud-Noord")
...
for (.v in oud_oost) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Oud-Oost")
...
for (.v in zuid) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Zuid")
...
for (.v in slotervaart) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Slotervaart")
...
for (.v in watergraafsmeer) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Watergraafsmeer")
...
for (.v in westerpark) WijkEnBuurten_combined$CrimeType <- str_replace(WijkEnBuurten_combined$CrimeType, .v, "Westerpark")

# Since it is not possible to create the next chucnk of code in a for loop. We did hard-code it.
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM01", "Jan2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM02", "Feb2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM03", "Mrt2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM04", "Apr2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM05", "May2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM06", "June2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM07", "July2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM08", "Aug2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM09", "Sept2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM10", "Oct2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM11", "Nov2021")
WijkEnBuurten_combined$Periods <- str_replace(WijkEnBuurten_combined$Periods, "2021MM12", "Dec2021")

View(WijkEnBuurten_combined)


WijkEnBuurten_combined_crime_summarized <- WijkEnBuurten_combined %>% 
  group_by(Neighborhoods, Periods, CrimeType) %>% 
  summarise(total_crime_sum = sum(RegisteredCrimes))

View(WijkEnBuurten_combined_crime_summarized)
...
```{r data-save}
write.csv(WijkEnBuurten_combined, "../data/police_data.csv", row.names = FALSE)
```